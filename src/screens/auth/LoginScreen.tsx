...
const styles = StyleSheet.create({
  ...
  input: { borderRadius: 12, padding: 12, marginBottom: 12, fontSize: 16, width: "100%" },
  button: { borderRadius: 12, padding: 14, alignItems: "center", marginTop: 8 },
  buttonText: { fontSize: 16, fontWeight: "600" },
  center: { flex: 1, justifyContent: "center", alignItems: "center", width: "100%", paddingHorizontal: 32},
});
